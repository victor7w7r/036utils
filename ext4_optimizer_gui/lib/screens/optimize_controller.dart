...
const _url = 'https://github.com/victor7w7r/036utils/releases/'
    'download/1.0.0/ext4_optimizer_cli-amd64';

Future<String> _downloadDir() => const Task(getTemporaryDirectory)
        ...
        yesNo(
          ...
          onYes: () async {
            ...
            if (!File(downloadDir).existsSync()) {
              unawaited(
                _download(_url, downloadDir, _cancel).then((final res) {
                  if (res) {
